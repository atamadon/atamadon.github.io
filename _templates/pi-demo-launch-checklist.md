# PI Demo and Launch-Readiness Checklist

Use this checklist to keep the immediate milestone focused on a credible PI demo while tracking the later publish-ready pass separately.

## PI Demo Readiness

- Pages CMS can edit team entries cleanly
- Pages CMS can create or update a news post cleanly
- Teaching content is editable through Pages CMS
